...
source/mandelbrot_ispc.o: source/mandelbrot.ispc
	ispc -O3   --opt=fast-math source/mandelbrot.ispc -o source/mandelbrot_ispc.o -h  source/mandelbrot_ispc.h --opt=fast-masked-vload --opt=force-aligned-memory --target=avx2-i32x16
